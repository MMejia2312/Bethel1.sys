...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['accion'] === 'agregar') {
    ...
    header("Location: pioneros.php?ok=1");
    exit;
}
// ---------- Editar / Eliminar ----------//
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['accion'] === 'editar') {
        ...
        header('Location: pioneros.php?ok=1'); exit;
    }
    if ($_POST['accion'] === 'eliminar') {
        eliminar_muchacho($_POST['id']);
        header('Location: pioneros.php?eliminado=1'); exit;
    }
}
//----------------------------------------------------------------//

// Consulta pioneros (Departamento 5)
$consultaGEN = "SELECT m.*, d.ID_DEPARTAMENTO, d.NOMBRE_DEP
                FROM muchachos m
                JOIN departamento d ON m.DEPARTAMENTO = d.ID_DEPARTAMENTO
                WHERE m.DEPARTAMENTO = '5'";
...
<head>
  ...
  <title>Registros pioneros Bethel 1</title>
...
<section class="bg-dark text-light text-center p-5">
  <div class="container" id="Tablapioneros">
    <h1 class="my-5"><span style="color:rgba(255,255,0,.9)">Registro de Pioneros</span></h1>
...
(() => {
  ...
  const tbody       = document.querySelector('#Tablapioneros tbody');
...
<!-- Registro de Pioneros aun por conectar-->
<section class="bg-dark text-light text-center p-5">
  <div class="container " id="TablaPioneros" >
    <h1 class="my-5"><span style="color:rgba(255, 255, 0, 0.911);">Registro de Pioneros</span></h1>
    <!--Filtros-->
    ...
    <!--FIN Registro de Pioneros aun por conectar-->
  </div>
</section>
<!-- FIN Registro de Pioneros aun por conectar-->
