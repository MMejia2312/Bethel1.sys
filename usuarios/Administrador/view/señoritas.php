...
<head>
  ...
  <title>Registros Señoritas Bethel 1</title>
...
<section class="bg-dark text-light text-center p-5">
  <div class="container" id="Tablaseñoritas">
    <h1 class="my-5"><span style="color:rgba(255,255,0,.9)">Registro de Señoritas</span></h1>
...
(() => {
  ...
  const tbody       = document.querySelector('#Tablaseñoritas tbody');
...
<!-- FIN barra de navegación superior -->
 ...
 <!--Registros Señoritas-->
 <section class="bg-dark text-light text-center p-5">
  <div class="container " id="TablaSenoritas" >
    <h1 class="my-5"><span style="color:rgba(255, 255, 0, 0.911);">Registro Señoritas</span></h1>
    <!--Filtros-->
    ...
    <!--FIN Registro de Señoritas aun por conectar-->
  </div>
</section>
<!--FIN Registros Señoritas-->
