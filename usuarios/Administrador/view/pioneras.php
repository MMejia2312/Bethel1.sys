...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['accion'] === 'agregar') {
    ...
    header("Location: pioneras.php?ok=1");
    exit;
}
// ---------- Editar / Eliminar ----------//
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['accion'] === 'editar') {
        ...
        header('Location: pioneras.php?ok=1'); exit;
    }
    if ($_POST['accion'] === 'eliminar') {
        eliminar_muchacho($_POST['id']);
        header('Location: pioneras.php?eliminado=1'); exit;
    }
}
//----------------------------------------------------------------//

// Consulta pioneras (Departamento 5)
$consultaGEN = "SELECT m.*, d.ID_DEPARTAMENTO, d.NOMBRE_DEP
                FROM muchachos m
                JOIN departamento d ON m.DEPARTAMENTO = d.ID_DEPARTAMENTO
                WHERE m.DEPARTAMENTO = '6'";
...
<head>
  ...
  <title>Registros pioneras Bethel 1</title>
...
<section class="bg-dark text-light text-center p-5">
  <div class="container" id="Tablapioneras">
    <h1 class="my-5"><span style="color:rgba(255,255,0,.9)">Registro de Pioneras</span></h1>
...
(() => {
  ...
  const tbody       = document.querySelector('#Tablapioneras tbody');
...
<!-- FIN barra de navegación superior -->
 ...
 <!--Registro de Pioneras-->
 <section class="bg-dark text-light text-center p-5">
  <div class="container " id="TablaPioneras" >
    <h1 class="my-5"><span style="color:rgba(255, 255, 0, 0.911);">Registro Señoritas Pioneras</span></h1>
    <!--Filtros-->
    ...
    <!--FIN Registro de Pioneras aun por conectar-->
  </div>
</section>
<!--FIN Registro de Pioneras-->
