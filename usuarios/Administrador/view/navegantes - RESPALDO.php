...
<!-- FIN barra de navegación superior -->
    ...
    <!-- Registro de Navegantes aun por conectar-->
    <section class="bg-dark text-light text-center p-5">
      <div class="container " id="TablaNavegantes" >
        <h1 class="my-5"><span style="color:rgba(255, 255, 0, 0.911);">Registro de Navegantes</span></h1>
        <!--Filtros-->
        ...
        <!--FIN Registro de Navegantes aun por conectar-->
      </div>
    </section>
    <!-- FIN Registro de Navegantes aun por conectar-->
